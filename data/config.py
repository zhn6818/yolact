...
# Original COCO classes (commented out)
...
# Original COCO label map (commented out)
...
# New classes for your dataset
COCO_CLASSES = ('M', 'B', 'P', )  # 添加 background 作为第一个类别

# New label map for your dataset
COCO_LABEL_MAP = {
    1: 1,  # M
    2: 2,  # B
    3: 3,  # P
...
dataset_base = Config({
    ...
    'train_images': './coco/coco/images/train2017',
    'train_info':   './coco/coco/annotations/instances_train2017.json',

    # Validation images and annotations.
    'valid_images': './coco/coco/images/val2017',
    'valid_info':   './coco/coco/annotations/instances_val2017.json',
